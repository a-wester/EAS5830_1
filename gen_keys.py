...
def sign_message(challenge, filename = "/home/codio/workspace/secret_key.txt"):
    """
    ...
    eth_addr = w3.eth.account.recover_message(message, signature=signed_message.signature)
